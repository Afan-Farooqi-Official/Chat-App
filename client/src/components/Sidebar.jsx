      ...
      <div className='pb-5'>
        ...
        <div className='flex flex-col gap-2 mt-2'>
          {userDummyData.map((user, index) => (
            <div onClick={()=>{setSelectUser(user)}} key={index} className={`relative flex items-center gap-2 pl-4 rounded cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
